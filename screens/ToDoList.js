    ...
    <>
      <View style={styles.toDoList}>
        <View style={styles.pageHeader}>
          ...
          <View style={[styles.frameParent, styles.toDoList1Position]}>
            ...
            <Text style={[styles.toDoList1, styles.toDoList1Position]}>
              To-do list
            </Text>
          </View>
        </View>
        <View style={[styles.rectangleParent, styles.nextPosition]}>
          <View style={[styles.frameChild, styles.nextPosition]} />
...
`}</Text>
          ...
          <View style={styles.frameGroup}>
            ...
            <View style={styles.frameView}>
              ...
              >
                ...
                <Image
                  style={[styles.carboncheckboxIcon1, styles.frameIconLayout]}
                  contentFit="cover"
                  source={require("../assets/carboncheckbox.png")}
                />
              </View>
        ...
        <View style={[styles.rectangleParent2, styles.frameChild3Layout]}>
          ...
          <View style={[styles.topDivider, styles.nextPosition]} />
