...
const NotificationMaskRead = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.notificationmaskRead}>
      ...
      <View style={styles.pageHeader}>
        ...
        <Text style={[styles.nofication, styles.markAllAsFlexBox]}>
          Nofication
        </Text>
      ...
      <Image
        style={[
          styles.notificationmaskReadChild,
          ...
          <View style={styles.frameParent}>
            <View style={[styles.frameGroup, styles.frameLayout]}>
              ...
              <View style={[styles.kpiEduParent, styles.kpiParentPosition]}>
                <Text style={[styles.kpiEdu, styles.kpiTypo]}>KPI EDU</Text>
                <Text
        ...
        <View style={[styles.frameParent2, styles.framePosition]}>
          <View style={[styles.frameParent3, styles.frameParentLayout]}>
            ...
            <View style={[styles.kpiEduParent2, styles.kpiParentPosition]}>
              <Text style={[styles.kpiEdu4, styles.kpiTypo]}>KPI EDU</Text>
              <Text
...
Color Design`}</Text>
      ...
      <Text style={[styles.markAllAs, styles.allTypo]}>Mark all as read</Text>
    </View>
  );
};
...
export default NotificationMaskRead;
