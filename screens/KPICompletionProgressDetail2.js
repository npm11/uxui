...
const KPICompletionProgressDetail2 = () => {
      ...
      <View style={[styles.scrollParent, styles.parentLayout]}>
        ...
        <View style={[styles.frameParent, styles.frameParentFlexBox]}>
          <View style={styles.planNameParent}>
            ...
            <Text style={[styles.salesWebsiteDesign, styles.text1Typo]}>
          ...
          <View style={styles.fromParent}>
            ...
            <View style={[styles.groupParent, styles.groupLayout1]}>
              <View style={[styles.rectangleGroup, styles.rectanglePosition]}>
                <View style={[styles.groupChild, styles.groupChildBorder]} />
                <Text style={[styles.text, styles.hTypo]}>08</Text>
                <Image
            ...
            <View style={[styles.groupContainer, styles.groupLayout1]}>
              ...
              >
                <View style={[styles.groupChild, styles.groupChildBorder]} />
                <Text style={[styles.h, styles.hTypo]}>10h</Text>
                <Image
              ...
              >
                <View style={[styles.groupChild, styles.groupChildBorder]} />
                <Text style={[styles.m, styles.hTypo]}>00m</Text>
                <Image
          ...
          <View style={styles.fromParent}>
            ...
            <View style={[styles.groupContainer, styles.groupLayout1]}>
              ...
              >
                <View style={[styles.groupChild, styles.groupChildBorder]} />
                <Text style={[styles.h, styles.hTypo]}>23h</Text>
                <Image
                  style={[styles.caretdownIcon3, styles.caretdownIconPosition]}
                  contentFit="cover"
                  source={require("../assets/caretdown7.png")}
              ...
              >
                <View style={[styles.groupChild, styles.groupChildBorder]} />
                <Text style={[styles.m, styles.hTypo]}>59m</Text>
                <Image
                  style={[styles.caretdownIcon4, styles.caretdownIconPosition]}
                  contentFit="cover"
                  source={require("../assets/caretdown8.png")}
          ...
          <View style={styles.descriptionOptionalParent}>
            <Text style={[styles.descriptionOptional, styles.fromTypo]}>
              <Text style={styles.descriptionOptionalTxtContainer}>
                <Text style={styles.fromTypo1}>{`Description `}</Text>
            ...
            <View style={[styles.groupParent2, styles.groupLayout]}>
              ...
              <Text style={styles.pleaseEnterDescription}>
          ...
          <View style={styles.frameGroup}>
            ...
            <View style={styles.rectangleParent8}>
              ...
              <View style={[styles.frameChild1, styles.frameLayout1]} />
            </View>
            <Image
            ...
            <View style={styles.taskListOptionalParent}>
              <Text
                style={[
                  ...
                  styles.salesWebsiteDesign1Position,
                ]}
              >
                <Text style={styles.fromTypo1}>{`Task list `}</Text>
                <Text style={styles.optional}>(Optional)</Text>
              </Text>
              <Image
          ...
          <View style={styles.groupParent3}>
            <Pressable
              ...
              onPress={() => navigation.navigate("KPICompletionProgressDetail")}
            >
        ...
        <View style={[styles.frameWrapper, styles.frameWrapperLayout]}>
          <View
            style={[styles.salesWebsiteDesignParent, styles.frameItemLayout]}
          >
            <Text
              style={[
                styles.salesWebsiteDesign1,
                styles.salesWebsiteDesign1Position,
              ]}
            >{`Sales website design `}</Text>
            <Text style={styles.wedMay8}>{`10:00 Wed May 8 - 23:59 Thu May 30
 `}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.rectangleParent10, styles.topDividerPosition]}>
        <View style={[styles.frameChild2, styles.topDividerPosition]} />
        ...
        <View style={styles.frameWrapper2}>
          <View style={[styles.frameParent1, styles.frameParentFlexBox]}>
            <View style={styles.frameParent2}>
              ...
              />
              <View style={[styles.frameChild3, styles.groupChildPosition]} />
            </View>
            <Pressable
...
const styles = StyleSheet.create({
  ...
  descriptionOptionalTxtContainer: {
    width: "100%",
  },
  descriptionOptional: {
    height: "18.65%",
...
export default KPICompletionProgressDetail2;
